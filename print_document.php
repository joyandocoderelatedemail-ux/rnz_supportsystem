...
$client_tradename = !empty($client['tradename']) ? $client['tradename'] : 'N/A';
$client_owner = !empty($client['clientname']) ? $client['clientname'] : 'N/A';
$client_address = !empty($client['address']) ? $client['address'] : 'N/A';
    ...
    <div class="no-print w-full max-w-4xl mb-6 flex flex-col sm:flex-row items-center justify-between gap-4 bg-slate-900 text-white p-4 rounded-2xl shadow-xl border border-slate-800">
        <div class="flex items-center space-x-3">
            ...
            <div>
                ...
                <p class="text-xs text-slate-400">Account #<?php echo sanitize($client_acct); ?> &bull; <?php echo sanitize($client_tradename); ?></p>
            </div>
        </div>
